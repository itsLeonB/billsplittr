...
// Source: github.com/itsLeonB/go-crud (interfaces: Transactor)
//
// Generated by this command:
//
//	mockgen -package=mocks -destination=internal/test/mocks/crud_mocks.go github.com/itsLeonB/go-crud Transactor
//
