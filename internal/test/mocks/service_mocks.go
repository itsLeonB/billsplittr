...
func (m *MockExpenseBillService) Delete(ctx context.Context, billID, profileID uuid.UUID) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Delete", ctx, billID, profileID)
	ret0, _ := ret[0].(error)
	return ret0
}

// Delete indicates an expected call of Delete.
func (mr *MockExpenseBillServiceMockRecorder) Delete(ctx, billID, profileID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockExpenseBillService)(nil).Delete), ctx, billID, profileID)
}

// Get mocks base method.
func (m *MockExpenseBillService) Get(ctx context.Context, billID, profileID uuid.UUID) (dto.ExpenseBillResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", ctx, billID, profileID)
...
func (mr *MockExpenseBillServiceMockRecorder) Get(ctx, billID, profileID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockExpenseBillService)(nil).Get), ctx, billID, profileID)
}

// Upload mocks base method.
func (m *MockExpenseBillService) Upload(ctx context.Context, req *dto.UploadBillRequest) (uuid.UUID, error) {
	m.ctrl.T.Helper()
...
func (mr *MockExpenseBillServiceMockRecorder) Upload(ctx, req any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Upload", reflect.TypeOf((*MockExpenseBillService)(nil).Upload), ctx, req)
}
